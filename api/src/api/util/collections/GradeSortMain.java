...
public class GradeSortMain {
	public static void main(String[] args) {
		...
		GradeVO g2 = new GradeVO("2012", "김길동", 80,70,60);
		GradeVO g3 = new GradeVO("2013", "장길동", 70,60,50);
		GradeVO g4 = new GradeVO("2014", "문길동", 60,50,40);
		...
		grades.add(new GradeVO("2015","최길동",90,90,90));
